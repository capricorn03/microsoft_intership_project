...
### flask run
(4) Run the flask app & upload any image  by clicking uplod and submit buttons form your local files and to check the functionality of report button click on
  "instant report" .
